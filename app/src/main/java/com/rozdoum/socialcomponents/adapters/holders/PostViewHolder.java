...
public class PostViewHolder extends RecyclerView.ViewHolder {
    ...
    public PostViewHolder(View view, final OnClickListener onClickListener, BaseActivity activity, boolean isAuthorNeeded) {
        ...
        alamatAduan = view.findViewById(R.id.alamatAduan);
    ...
    public void bindData(Post post) {
        ...
        alamatAduan.setText(post.getAlamat());
        ...
        if (post.getAuthorId() != null) {
            profileManager.getProfileSingleValue(post.getAuthorId(), createProfileChangeListener(authorUserName,authorImageView));
        }
