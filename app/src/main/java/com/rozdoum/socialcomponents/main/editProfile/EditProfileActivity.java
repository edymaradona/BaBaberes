...
public class EditProfileActivity<V extends EditProfileView, P extends EditProfilePresenter<V>> extends PickImageActivity<V, P> implements EditProfileView {
    ...
    // UI references.
    private EditText nameEditText,deskripsiEditText,alamatEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deskripsiEditText = findViewById(R.id.descriptionEditText);
    ...
    public void setDescription(String description) {
        deskripsiEditText.setText(description);
    }
    ...
    public String getDescriptionText() {
        return deskripsiEditText.getText().toString();
    }
    ...
    @Override
    public void setDescriptionError(@Nullable String string) {
        deskripsiEditText.setError(string);
        deskripsiEditText.requestFocus();
    }

    @Override
    public void setAlamatError(@Nullable String string) {
        alamatEditText.setError(string);
