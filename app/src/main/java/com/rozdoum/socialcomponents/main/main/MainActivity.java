...
import com.rozdoum.socialcomponents.main.news.createNews.CreateNewsActivity;
...
public class MainActivity extends BaseActivity<MainView, MainPresenter> implements MainView {
    ...
    private FloatingActionButton floatingActionButtonNews;
    ...
    private void initFloatingActionButton() {
        ...
        floatingActionButtonNews = findViewById(R.id.addNewNewsFab);
        if (floatingActionButtonNews != null) {
            floatingActionButtonNews.setOnClickListener(v -> presenter.onCreateNewsClickAction(floatingActionButtonNews));
        }
    }
    ...
    public void showFloatButtonRelatedSnackBar(int messageId) {
        ...
        showSnackBar(floatingActionButtonNews,messageId);
    }
    ...
    @Override
    public void openCreateNewsActivity() {
        Intent intent = new Intent(this, CreateNewsActivity.class);
        startActivityForResult(intent, CreateNewsActivity.CREATE_NEW_NEWS_REQUEST);
    }
