...
public class EditPostPresenter extends BaseCreatePostPresenter<EditPostView> {
    ...
    @Override
    protected void savePost(final String title, final String description, final String alamat, final Double longitude, final Double latitude, final String status) {
        ifViewAttached(view -> {
