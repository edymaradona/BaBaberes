            ...
            public void onObjectChanged(Profile obj) {
                ...
                ifViewAttached(view -> {
                    if (profile != null) {
                        ...
                        view.setAlamat(profile.getAlamat());
    ...
    public void attemptCreateProfile(Uri imageUri) {
        if (checkInternetConnection()) {
            ifViewAttached(view -> {
                ...
                String alamat = view.getAlamatText().trim();
                ...
                if (TextUtils.isEmpty(description)) {
                    view.setDescriptionError(context.getString(R.string.error_field_required));
                    cancel = true;
                } else if (!ValidationUtil.isDescriptionValid(description)) {
                    view.setDescriptionError(context.getString(R.string.error_profile_name_length));
                    cancel = true;
                }

                if (TextUtils.isEmpty(alamat)) {
                    view.setAlamatError(context.getString(R.string.error_field_required));
                    cancel = true;
                } else if (!ValidationUtil.isDescriptionValid(alamat)) {
                    view.setAlamatError(context.getString(R.string.error_profile_name_length));
                    cancel = true;
                }
