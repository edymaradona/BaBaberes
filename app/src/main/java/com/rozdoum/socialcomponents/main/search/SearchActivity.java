...
import com.rozdoum.socialcomponents.main.search.news.SearchNewsFragment;
...
public class SearchActivity extends BaseActivity<SearchView, SearchPresenter> implements SearchView {
    ...
    private void initTabs() {
        ...
        Bundle argsNewsTab = new Bundle();
        tabsAdapter.addTab(SearchNewsFragment.class, argsNewsTab, getResources().getString(R.string.news_tab_titlr));
