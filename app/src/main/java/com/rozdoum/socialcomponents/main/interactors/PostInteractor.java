            ...
            for (String key : objectMap.keySet()) {
                ...
                if (obj instanceof Map) {
                    ...
                    if (!hasComplain) {
                        ...
                        post.setAlamat((String) mapObj.get("alamat"));
                        post.setLongitude((Double) mapObj.get("longitude"));
                        post.setLatitude((Double) mapObj.get("latitude"));
                        post.setStatus((String) mapObj.get("status"));
