package com.rozdoum.socialcomponents.main.location;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public static final String POST_EXTRA_KEY = "MapsActivity.POST_EXTRA_KEY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userID = getIntent().getStringExtra(POST_EXTRA_KEY);
