...
public class Constants {
    ...
    public static class News {
        public static final int MAX_NEWS_TEXT_LENGTH_IN_LIST = 300; //characters
        public static final int MAX_NEWS_TITLE_LENGTH = 255; //characters
        public static final int NEWS_AMOUNT_ON_PAGE = 10;
    }
