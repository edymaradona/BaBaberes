...
public class PreferencesUtil {
    ...
    private static final String PREF_PARAM_IS_NEWS_WAS_LOADED_AT_LEAST_ONCE = "isNewsWasLoadedAtLeastOnce";
    ...
    public static Boolean isNewsWasLoadedAtLeastOnce(Context context) {
        return getSharedPreferences(context).getBoolean(PREF_PARAM_IS_NEWS_WAS_LOADED_AT_LEAST_ONCE, false);
    }
    ...
    public static void setNewsWasLoadedAtLeastOnce(Context context, Boolean isNewsWasLoadedAtLeastOnce) {
        getSharedPreferences(context).edit().putBoolean(PREF_PARAM_IS_NEWS_WAS_LOADED_AT_LEAST_ONCE, isNewsWasLoadedAtLeastOnce).commit();
    }
